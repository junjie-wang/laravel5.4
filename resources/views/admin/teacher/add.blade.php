        ...
        <div class="content">
            ...
            <div class="flexilist">
                ...
                <div class="common-content">
                    <div class="mian-info">
                        <form name="theForm" method="post" id="user_form" action="{{url('/admin/teachers/create')}}">
                            {{csrf_field()}}
                            <div class="switch_info">
                                <div class="item">
                                    <div class="label"><span class="require-field">*</span>用户名：</div>
                                    <div class="label_value">
                                        <input type="text" id="user_name" name="name" class="text" value=""
                                               autocomplete="off">
                                ...
                                <div class="item">
                                    ...
                                    <div class="label_value">
                                        <label><input name="sex" type="radio" value="3" checked/>未知 </label>
                                ...
                                <div class="item">
                                    ...
                                    <div class="label_value">
                                        <input type="text" id="mobile" name="mobile" class="text" value=""
                                               autocomplete="off">
                                        <div class="form_prompt"></div>
                                    </div>
                                </div>
                                ...
                                <div class="item">
                                    <div class="label"><span class="require-field">*</span>专业：</div>
                                    <div class="label_value">
                                        <input type="text" name="subject" class="text" id="subject" value=""
                                               autocomplete="off">
                                        <div class="form_prompt"></div>
                                    </div>
                                </div>
