    ...
    <div class="content">
        ...
        <div class="flexilist">
            ...
            <div class="common-content">
                <div class="mian-info">
                    <form name="theForm" method="post" id="user_form" action="/admin/teachers/{{$teacher->id}}">
                        {{csrf_field()}}
                        <div class="switch_info">
                            <div class="item">
                                <div class="label"><span class="require-field">*</span>用户名：</div>
                                <div class="label_value">
                                    <input type="text" id="user_name" name="name" class="text" value="{{$teacher->name}}" autocomplete="off">
                            ...
                            <div class="item">
                                ...
                                <div class="label_value">
                                    <input type="text" id="mobile" name="mobile" class="text" value="{{$teacher->mobile}}" autocomplete="off">
                                    <div class="form_prompt"></div>
                                </div>
                            </div>
                            <div class="item">
                                ...
                                <div class="label_value">
                                    <input type="text" name="email" class="text" id="email" value="{{$teacher->email}}" autocomplete="off">
                                    <div class="form_prompt"></div>
                                </div>
                            </div>
                            <div class="item">
                                ...
                                <div class="label_value">
                                    <input type="text" id="subject" name="subject" class="text" value="{{$teacher->subject}}" autocomplete="off">
                                    <div class="form_prompt"></div>
                                </div>
                            </div>
                            <div class="item">
